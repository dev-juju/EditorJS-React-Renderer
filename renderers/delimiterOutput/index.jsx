...
const supportedStyles = ['container', 'svg', 'path'];
...
const DelimiterOutput = ({ style }) => {
  ...
  return (
    <div style={{ ...delimiterOutputStyle.container, ...style.container }}>
      <svg style={{ ...delimiterOutputStyle.svg, ...style.svg }} version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg'
        xmlnsXlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 100.353 100.353' xmlSpace='preserve'>
      <path style={{ ...delimiterOutputStyle.path, ...style.path }} d='M98.544,48.543c-25.998,0-47.15-20.904-47.15-46.599c0-0.804-0.652-1.456-1.456-1.456
